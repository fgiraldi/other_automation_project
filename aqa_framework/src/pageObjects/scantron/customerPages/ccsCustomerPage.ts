export const ccsCustomerPage = {
    ...
    'Register New Candidate': '//p[@class="ng-binding"]',
    'Candidate Email Address': '//input[@type="email"]',
    Submit: '//button[@title="Submit Application"]',
    'First Name': '//input[contains(@id,"txtFirstName")]',
    'Last Name': '//input[contains(@id,"txtLastName")]',
    Next: '//span[@class="wizard-next-prev"]',

    //Tailwind Placement Exam: English
    'English Exam': '//input[@ng-value="13222"]',
    //Tailwind Placement Exam: College Math Fundamentals
    'Math Exam': '//input[@ng-value="14403"]',

    'Radio Button': '//input[@ng-value="choice"]',
    'Ok Button': '//button[@ng-click="ok()"]',
    'English Exam Checkbox': '//label[@class="ng-binding"]',
    'Test Now': '//h4[.="Test Now"]',
    'OK to Continue': '//button[contains(text(), "OK")]',
    'Policy Agree': '//span[contains(text(), "Agree")]',
    'Attest Box': '//input[@ng-value="13222"]',
    Continue: '//input[@value="Continue"]',

    //Exam Candidate Attestation
    'Give Unauthorized Assistance':
        '//label[contains(text(), "I will not give any unauthorized assistance on this exam.")]',
    'Receive Unauthorized Assistance':
        '//label[contains(text(), "I will not receive any unauthorized assistance on this exam.")]',
    ...
    'Remove Items':
        '//label[contains(text(), "I will not remove any items from the testing center.")]',
    'Prohibited Items':
        '//label[contains(text(), "I do not have any of the following prohibited items or I have turned these items over to the proctor:")]',
    'Alert Proctor':
        '//label[contains(text(), "I will alert the proctor immediately if I have any concerns about the test administration, including if the testing environment becomes unacceptable to me, or if I have any concerns about the testing computer.")]',
    'Invalid Exam':
        '//label[contains(text(), "I understand that if I am found with any prohibited item noted above, including cell phones, notes, and other prohibited items, I may be dismissed and my exam may be invalidated.")]',
    'I attest':
        '//input[@id="ctl00_ctl00_MainBodyBase_MainBody_txtAttestation"]',
    'Submit Candidate Attestation': '//input[@type="submit"]',
    'Begin Test': '//input[@value="Begin test immediately."]',
    'Take Test': '//input[@value="Take the test"]',

    //Exam
    'Next Question': '//a[@id="btnNextQuestion"]',
    'Submit Exam': '//div[@class="casSubmitButton"]',
    'I Understand': '//input[@id="confSubmitInputBox"]',
    'Confirm Submit My Exam': '//a[@onclick="ConfirmSubmit()"]',
};
